...
import { Search, Briefcase, MapPin, DollarSign, IndianRupee, ArrowLeft, ArrowRight, Info } from 'lucide-react';
                        ...
                        <div className="md:w-1/2 mb-8 md:mb-0">
                            ...
                            <div className="mt-6 flex">
                                ...
                                <button
                                    ...
                                    className="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-r transition-colors duration-300 flex items-center"
                                >
                ...
                <div className="max-w-5xl mx-auto px-4">
                    ...
                    <div className="grid md:grid-cols-3 gap-6">
                        {featuredJobs.slice(0, 6).map((job) => (
                            <div
                                key={job.id}
                                className="bg-white rounded-lg p-6 shadow-sm hover:shadow-md hover:-translate-y-1 transition-all duration-300"
                            >
